...
public class FancyMessage {
    ...
    public static String BOSS_FELLED =
            "\n" +
                    "                                                                                                                        \n" +
                    "                                                                                                                        \n" +
                    "`7MM\"\"\"Yp,   .g8\"\"8q.    .M\"\"\"bgd  .M\"\"\"bgd     `7MM\"\"\"YMM `7MM\"\"\"YMM  `7MMF'      `7MMF'      `7MM\"\"\"YMM  `7MM\"\"\"Yb.   \n" +
                    "  MM    Yb .dP'    `YM. ,MI    \"Y ,MI    \"Y       MM    `7   MM    `7    MM          MM          MM    `7    MM    `Yb. \n" +
                    "  MM    dP dM'      `MM `MMb.     `MMb.           MM   d     MM   d      MM          MM          MM   d      MM     `Mb \n" +
                    "  MM\"\"\"bg. MM        MM   `YMMNq.   `YMMNq.       MM\"\"MM     MMmmMM      MM          MM          MMmmMM      MM      MM \n" +
                    "  MM    `Y MM.      ,MP .     `MM .     `MM       MM   Y     MM   Y  ,   MM      ,   MM      ,   MM   Y  ,   MM     ,MP \n" +
                    "  MM    ,9 `Mb.    ,dP' Mb     dM Mb     dM       MM         MM     ,M   MM     ,M   MM     ,M   MM     ,M   MM    ,dP' \n" +
                    ".JMMmmmd9    `\"bmmd\"'   P\"Ybmmd\"  P\"Ybmmd\"      .JMML.     .JMMmmmmMMM .JMMmmmmMMM .JMMmmmmMMM .JMMmmmmMMM .JMMmmmdP'   \n" +
                    "                                                                                                                        \n" +
                    "                                                                                                                        \n";
}
